public static class WaitForController
{
    ...
    public static void MakeDecision(Decision phaseOne, int player, int card)
    {
        MainCorutine.MakeDecisionPhaseOne(phaseOne, player, card);
    }
